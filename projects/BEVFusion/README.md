...
| Modality                                                                 | Voxel type (voxel size) | NMS | Mem (GB) | Inf time (fps) | NDS  | mAP  | Download/Notes |
|--------------------------------------------------------------------------|:-----------------------:|:---:|:--------:|:--------------:|:----:|:----:|:--------------|
...
| [lidar-cam, XPU single device](./configs/bevfusion_lidar-cam_voxel0075_second_secfpn_8xb4-cyclic-20e_nus-3d.py) | voxel (0.075)           |  ×  |    -     |       -        | 71.2 | 68.4 | (this work, XPU, single device) |
| [lidar-cam, XPU single device (PTQ)](./configs/bevfusion_lidar-cam_voxel0075_second_secfpn_8xb4-cyclic-20e_nus-3d.py) | voxel (0.075) | × | - | - | 71.2 | 68.4 | (this work, XPU, single device, INT8 PTQ; `PYTORCH_ENABLE_XPU_FALLBACK=1`) |
| [lidar, XPU single device](./configs/bevfusion_lidar_voxel0075_second_secfpn_8xb4-cyclic-20e_nus-3d.py) | voxel (0.075) | × | - | - | 69.2 | 64.4 | (this work, XPU, single device, lidar-only) |
